package nibm.mad.snapshop.presentation.screens.permissions
...
fun MediaPermissionScreen(
    ...
    Column(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.media_permission_icon),
                contentDescription = "Media Permission Required Graphic",
            ...
            Column(
                ...
                Text(
                    text = "Granting Media Access allows\nyou to choose media from both\nthe Gallery and Search",
                    color = TextSecondary,
                    fontSize = 18.sp,
...
@Preview
@Composable
fun MediaPermissionScreenPreview() {
